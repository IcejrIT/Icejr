...
<body>
    ...
    <div id="content2">
        <div class="left1">
            <img src='../obrazki/promocja/5.png'>
        </div>
        <div class="right1">
            <form name='action' method='post' action=''>
            <h2>🎧 Słuchawki Gamingowe 🎧</h2><br>
            <p>Cena</p><br>
            ...
            <?php
                    ...
                    <input type='hidden' name='obrazek' value='5'>
                    <input type='hidden' name='nazwa' value='Słuchawki Gamingowe'>
