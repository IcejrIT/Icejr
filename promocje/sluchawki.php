...
<body>
    ...
    <div id="content2">
        <div class="left1">
            <img src='../obrazki/promocja/1.png'>
        </div>
        <div class="right1">
        <form name='action' method='post' action=''>
            <h2>🎧 Słuchawki Przewodowe 🎧</h2><br>
            <p>Cena</p><br>
            <p><span>29,99</span> zł</p> <br>
            <?php
                    if (isset($_SESSION['zalogowany']))
                    {
                    print ("
                    ...
                    <input type='hidden' name='obrazek' value='1'>
                    <input type='hidden' name='nazwa' value='Słuchawki Przewodowe'>
                    <input type='hidden' name='cena' value='29.99'>
