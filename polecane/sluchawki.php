...
<head>
    ...
    <title>🎧 Słuchawki STEELSERIES Arctis 5 🎧</title>
</head>
<body>
    ...
    <div id="content2">
        <div class="left1">
            <img src='../obrazki/polecane/1.png'>
        </div>
        <div class="right1">
            <form name='action' method='post' action=''>
            <h2>🎧 Słuchawki STEELSERIES Arctis 5 🎧</h2><br>
            <p>Cena</p><br>
            <p><span>399,99</span> zł</p> <br>
            <?php
                    if (isset($_SESSION['zalogowany']))
                    {
                    print ("
                    ...
                    <input type='hidden' name='obrazek' value='6'>
                    <input type='hidden' name='nazwa' value='Słuchawki STEELSERIES Arctis 5'>
                    <input type='hidden' name='cena' value='399.99'>
