...
<body>
    ...
    <div id="content2">
        <div class="left1">
            <img src='../obrazki/polecane/3.png'>
        </div>
        <div class="right1">
            <form name='action' method='post' action=''>
            <h2>⚡ Pralka WHIRLPOOL ⚡</h2><br>
            <p>Cena</p><br>
            <p><span>949,99</span> zł</p> <br>
            <?php
                    if (isset($_SESSION['zalogowany']))
                    {
                    print ("
                    ...
                    <input type='hidden' name='obrazek' value='8'>
                    <input type='hidden' name='nazwa' value='Pralka WHIRLPOOL'>
                    <input type='hidden' name='cena' value='949.99'>
