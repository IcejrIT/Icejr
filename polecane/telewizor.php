...
<head>
    ...
    <title>📺 Telewizor SAMSUNG QE65Q80A 📺</title>
</head>
<body>
    ...
    <div id="content2">
        <div class="left1">
            <img src='../obrazki/polecane/5.png'>
        </div>
        <div class="right1">
            <form name='action' method='post' action=''>
            <h2>📺 Telewizor SAMSUNG QE65Q80A 📺</h2><br>
            <p>Cena</p><br>
            <p><span>3999,99</span> zł</p> <br>
            <?php
                    if (isset($_SESSION['zalogowany']))
                    {
                    print ("
                    ...
                    <input type='hidden' name='obrazek' value='10'>
                    <input type='hidden' name='nazwa' value='Telewizor SAMSUNG QE65Q80A'>
                    <input type='hidden' name='cena' value='3999.99'>
