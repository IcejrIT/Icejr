...
<head>
    ...
    <title>⌨️ Klawiatura LOGITECH G915 ⌨️</title>
</head>
<body>
    ...
    <div id="content2">
        <div class="left1">
            <img src='../obrazki/polecane/2.png'>
        </div>
        <div class="right1">
            <form name='action' method='post' action=''>
            <h2>⌨️ Klawiatura LOGITECH G915 ⌨️</h2><br>
            <p>Cena</p><br>
            <p><span>929,99</span> zł</p><br>
                    <?php
                    if (isset($_SESSION['zalogowany']))
                    {
                    print ("
                    ...
                    <input type='hidden' name='obrazek' value='7'>
                    <input type='hidden' name='nazwa' value='Klawiatura LOGITECH G915'>
                    <input type='hidden' name='cena' value='929.99'>
